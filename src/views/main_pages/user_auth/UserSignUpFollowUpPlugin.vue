      ...
      <div class="modal-dialog h-100 d-flex flex-column justify-content-center my-0">
        <div class="modal-content">
          ...
          <div class="modal-footer">
            ...
            <div class="col-6 text-center">
              <router-link target="_blank" :to="{name:'kyc_verification_plugin'}" class="btn btn-danger">I confirm that I saved it safely</router-link>
            </div>
          </div>
        </div><!-- /.modal-content -->
      </div><!-- /.modal-dialog -->
  ...
  export default {
    ...
    methods: {
      ...
      generateWallet() {
        ...
        if (is_mobile){
          this.error_message = 'To make sure you save the wallet file carefully, please use your desktop or laptop to generate the wallet.'
          return
        }
